...
function nestor_preprocess_html(&$variables) {
  ...
  //drupal_add_js('https://maps.googleapis.com/maps/api/js?key=AIzaSyDCob92Ti5YP7UUwqjp1_F8CdToLK9gusw&libraries=places', 'external');
...
function nestor_preprocess_page(&$variables) {
  ...
  //if($alias == 'user/registration/employee') {
	//$variables['theme_hook_suggestions'][] = 'page__employee_registration';
  //}
