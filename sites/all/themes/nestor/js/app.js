(function ($) {
  "use strict;"
	...
	$(document).ready(function() {
		...
		$("#block-user-login .form-item.form-group.form-type-textfield.form-item-name input").attr("placeholder", "username");
		$("#block-user-login .form-item.form-group.form-type-password.form-item-pass input").attr("placeholder", "password");
		$("#block-user-login input.btn-primary").attr("value", "Go");
		$("button#search-toggle").click(function(){
			$(".job-search-left.col-lg-3.col-md-4.col-sm-5").toggle();
