            ...
            <div id="footer-right-region" class="footer-right region-top-sm-0 col-xs-12 col-md-6 text-right text-center-sm">
              <div class="region">
                ...
                <div id="social-networks-footer-block" class="social-networks-footer block">
                  <a href="https://www.facebook.com/TsSkills"><i class="icon ion-social-facebook"></i></a>
                  <a href="https://twitter.com/topsecretskills"><i class="icon ion-social-twitter"></i></a>
                  <a href="https://www.linkedin.com/company/1367027?trk=tyah"><i class="icon ion-social-linkedin"></i></a>
